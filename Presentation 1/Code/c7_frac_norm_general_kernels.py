...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("L"+str(k)+"Gaussian (Dim="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("L"+str(k)+"Polynomial (Dim="+str(dim)+")") 
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("L"+str(k)+"Rational Quadratic (Dim="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("L"+str(k)+"Inverse Multi-Quadratic (Dim="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("L"+str(k)+"Cauchy (Dim="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("L"+str(k)+"Matern Kernel (Dim="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("L"+str(k)+"LaPlace Kernel (Dim="+str(dim)+")")
	ax.legend() 
