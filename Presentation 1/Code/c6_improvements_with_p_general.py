...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("p-Rational Quadratic (Dim="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("p-Inverse Multi-Quadratic (Dim="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("p-Cauchy (Dim="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("p-Matern Kernel (Dim="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("p-LaPlace Kernel (Dim="+str(dim)+")")
	ax.legend() 
