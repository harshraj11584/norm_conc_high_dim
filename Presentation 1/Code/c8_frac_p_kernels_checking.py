...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("fp-Gaussian (Dimension="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("fp-Rational Quadratic (Dim="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("fp-Inverse Multi-Quadratic (Dim="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("fp-Cauchy (Dim="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("fp-Matern Kernel (Dim="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("fp-LaPlace Kernel (Dim="+str(dim)+")")
	ax.legend() 
