...
for dim in dimensions:
	...
	ax.set_title("fractional p-Gaussian (Dimension d="+str(dim)+")")
	ax.legend() 
	fig.savefig('../Graphs/g8_improvement_fp_Gaussian_dim='+str(dim)+'.png')
...
for dim in dimensions:
	...
	ax.set_xlabel('Distance')
	ax.set_ylabel('Kernel Values')
	ax.set_title("fractional p-Rational Quadratic (Dimension d="+str(dim)+")")
	ax.legend() 
	fig.savefig('../Graphs/g8_improved_fp_RationalQuadratic_dim='+str(dim)+'.png')
...
for dim in dimensions:
	...
	ax.set_xlabel('Distance')
	ax.set_ylabel('Kernel Values')
	ax.set_title("fractional p-Inverse Multi-Quadratic (Dimension d="+str(dim)+")")
	ax.legend() 
	fig.savefig('../Graphs/g8_improved_fp_InverseMultiQuadratic_dim='+str(dim)+'.png')
...
for dim in dimensions:
	...
	ax.set_xlabel('Distance')
	ax.set_ylabel('Kernel Values')
	ax.set_title("fractional p-Cauchy (Dimension d="+str(dim)+")")
	ax.legend() 
	fig.savefig('../Graphs/g8_improved_fp_Cauchy_dim='+str(dim)+'.png')
...
for dim in dimensions:
	...
	ax.set_xlabel('Distance')
	ax.set_ylabel('Kernel Values')
	ax.set_title("fractional p-Matern Kernel (Dimension d="+str(dim)+")")
	ax.legend() 
	fig.savefig('../Graphs/g8_improved_fp_Matern_dim='+str(dim)+'.png')
...
for dim in dimensions:
	...
	ax.set_xlabel('Distance')
	ax.set_ylabel('Kernel Values')
	ax.set_title("fractional p-LaPlace Kernel (Dimension d="+str(dim)+")")
	ax.legend() 
	fig.savefig('../Graphs/g8_improved_fp_LaPlace_dim='+str(dim)+'.png')
