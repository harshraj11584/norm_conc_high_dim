...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("Polynomial (Dim="+str(dim)+")") 
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("Rational Quadratic (Dim="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("Inverse Multi-Quadratic (Dim="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("Cauchy (Dim="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("Matern Kernel (Dim="+str(dim)+")")
	ax.legend() 
...
for dim in dimensions:
	...
	ax.axvline(d_5,ls='--')
	ax.axvline(d_95,ls='--')
	ax.set_title("LaPlace Kernel (Dim="+str(dim)+")")
	ax.legend() 
